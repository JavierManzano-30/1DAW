...
-- Volcando datos para la tabla northwind.categories: ~8 rows (aproximadamente)
...
-- Volcando datos para la tabla northwind.customers: ~91 rows (aproximadamente)
...
-- Volcando datos para la tabla northwind.employees: ~10 rows (aproximadamente)
...
-- Volcando datos para la tabla northwind.orderdetails: ~518 rows (aproximadamente)
...
-- Volcando datos para la tabla northwind.orders: ~196 rows (aproximadamente)
DELETE FROM `orders`;
...
-- Volcando datos para la tabla northwind.products: ~77 rows (aproximadamente)
...
-- Volcando datos para la tabla northwind.shippers: ~3 rows (aproximadamente)
...
-- Volcando datos para la tabla northwind.suppliers: ~29 rows (aproximadamente)
